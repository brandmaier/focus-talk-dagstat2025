...
Therefore, the permutation importance estimate will be influenced by differences with respect to all parameters of the model
...
- Compute -2LL of $x$ under $M_2$ with focus parameters plugged in from $M_1$
